...
type Client struct {
	...
	do         doFunc
	//-- 2021-10-18 => LHK 추가
	ReqCount RestReqCount
}

//-- 2021-10-18 => LHK 추가
type RestReqCount struct {
	ReqTime       int64 //서버시간
	ReqCount      int64 //1분당 요청수
	Order1MCount  int64 // 1분당 주문수
	Order10SCount int64 // 10초당 주문수
}
...
func (c *Client) callAPI(ctx context.Context, r *request, opts ...RequestOption) (data []byte, err error) {
	...
	if res.StatusCode >= 400 {
		...
		apiErr.OrgErrorMsg = string(data)
...
//NewMultipleNewOrdersService 멀티주문
func (c *Client) NewMultipleNewOrdersService() *MultipleNewOrdersService {
	return &MultipleNewOrdersService{c: c}
}
